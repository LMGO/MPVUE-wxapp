<template>
  <div>
    <!-- 发表内容填写框 -->
    <div class="content">
      <textarea v-model="microDes" type="text" placeholder="分享你的生活吧" rows="5" maxlength="200"></textarea>
    </div>
    <!-- 本地图片添加区 -->
    ...
    export default {
      ...
      methods:{
        ...
        publish(){
          ...
          let _this = this;
          // _this.microTime = _this.$store.state.getTime();
          ...
          _this.$fly.post('http://106.14.83.188:8080/admin/insertwespace',_this.$qs.stringify({
              userId: _this.$store.state.userInfo.userId,
              userNickname:_this.$store.state.userInfo.userNickname,
              microDes: _this.microDes,
              microTime:_this.$store.state.getTime(),
